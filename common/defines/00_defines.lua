...
NAI = {
	...
	DESIRE_USE_XP_TO_UNLOCK_ARMY_SPIRIT = 0.2,    -- How quickly is desire to unlock army spirits accumulated?
	DESIRE_USE_XP_TO_UNLOCK_NAVY_SPIRIT = 0.2,   -- How quickly is desire to unlock naval spirits accumulated?
	DESIRE_USE_XP_TO_UNLOCK_AIR_SPIRIT = 0.2,     -- How quickly is desire to unlock air spirits accumulated?
